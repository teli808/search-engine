...
# Indexing Statistics:
  ...
  • Due to the large amount of pages in this domain and memory constraints, the program offloaded the inverted index to separate files on disk 6 times during this indexing process, then merged them at the end.  
